...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("MyShop' Products"), backgroundColor: Colors.red[300],
      ),
      body: Center(
        child: Column(
          children: [
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        imageUrl: CONFIG.SERVER + "/myshop/images/products/${_productList[index]['prid']}.png",
                                        height: 150,
                                        width: 150,)
                                      ),
                                    Row(
    ...
    http.post(
      Uri.parse(CONFIG.SERVER + "/myshop/php/loadproducts.php"),
      body: {
      }).then(
        (response){
